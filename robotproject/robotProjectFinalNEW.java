...
public class robotProjectFinalNEW extends Frame
{  public static void main(String[] args){new robotProjectFinalNEW();}
   
   robotProjectFinalNEW()
   {  super("robotProjectFinalNEW");
      addWindowListener(new WindowAdapter()
         {public void windowClosing(WindowEvent e){System.exit(0);}});
      setSize(1200, 800);
      add("Center", new CvrobotProjectFinalNEW());
      show();
   }
}

class CvrobotProjectFinalNEW extends Canvas
{  public void paint(Graphics g)
   {  
	...
	while(count == 0){
		...
		double theta = Math.PI/4 * icount * -1;
		double theta1 = Math.PI/4 * acount * -1;
